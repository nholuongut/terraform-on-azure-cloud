...
```t
# Clone Github Repo
git clone https://github.com/nholuongut/terraform-on-azure-cloud
git clone https://github.com/nholuongut/terraform-on-azure-with-azure-devops
```
...
https://github.com/nholuongut/terraform-on-azure-with-azure-devops
```
...
- For detailed understanding we need to reference this topic from our [Demo-67: Azure HashiCorp Terraform Associate Certification Demos](https://github.com/nholuongut/hashicorp-certified-terraform-associate-on-azure/tree/main/67-Terraform-Manage-Providers). Primarily refer [Step-04](https://github.com/nholuongut/hashicorp-certified-terraform-associate-on-azure/tree/main/67-Terraform-Manage-Providers#step-04-command-terraform-providers-lock) and [Step-05](https://github.com/nholuongut/hashicorp-certified-terraform-associate-on-azure/tree/main/67-Terraform-Manage-Providers#step-05-command-terraform-providers-lock-for-all-supported-platforms) of this section
```t
...
# Verify the same on Remote Repository
https://github.com/nholuongut/terraform-on-azure-with-azure-devops.git
```
...
- **Name your Azure DevOps organization:** nholuongut1
...
- Go to  Azure DevOps -> Organization (nholuongut1) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Pipelines
- Click on **New Pipeline**
- **Where is your code?:** GitHub
- Follow browser redirect steps to integrate with Github Account
- **Select a repository:** nholuongut/terraform-on-azure-with-azure-devops
...
- Go to  Azure DevOps -> Organization (nholuongut1) -> Project (terraform-on-azure-with-azure-devops) > Project Settings -> Pipelines -> Service Connections
...
- We have already created that as part of [Section-24-Step-02](https://github.com/nholuongut/terraform-on-azure-cloud/tree/main/24-Terraform-Remote-State-Storage#step-02-create-azure-storage-account) which will re-use here. 
```t
...
- Go to  Azure DevOps -> Organization (nholuongut1) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Releases
- Click on **New Release Pipeline**
- **Pipeline Name:** Terraform-CD
### Dev Stage
- **Stage Name:** Dev Stage
- **Stage Owner:** nholuongut@gmail.com (your-azure-admin-id)
...
- Go to  Azure DevOps -> Organization (nholuongut1) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Releases -> Terraform-CD
...
- Go to  Azure DevOps -> Organization (nholuongut1) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Pipelines -> Terraform Continuous Integration CI Pipeline
...
- Go to  Azure DevOps -> Organization (nholuongut1) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Releases -> Terraform CD -> Edit
