...
sudo echo "Welcome to nholuongut - WebVM App2 - VM Hostname: $(hostname)" > /var/www/html/index.html
sudo mkdir /var/www/html/app2
sudo echo "Welcome to nholuongut - WebVM App2 - VM Hostname: $(hostname)" > /var/www/html/app2/hostname.html
sudo echo "Welcome to nholuongut - WebVM App2 - App Status Page" > /var/www/html/app2/status.html
